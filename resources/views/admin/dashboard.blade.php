...
@section('content')
    ...
    <div class="row mb-5">
        ...
        <x-dashboard-card title="Utilisateurs" :count="$usersCount ?? 0" icon="bi-people-fill"
            iconBgClass="bg-primary bg-opacity-10 text-primary" buttonText="Gérer" :buttonUrl="route('admin.user')" buttonClass="primary" />

        <x-dashboard-card title="Demandes d’aide" :count="$requestsCount ?? 0" icon="bi-cart-fill"
            iconBgClass="bg-success bg-opacity-10 text-success" buttonText="Gérer" :buttonUrl="route('admin.help-requests.index')" buttonClass="success" />

        <x-dashboard-card title="Missions" :count="$missionsCount ?? 0" icon="bi-list-check"
            iconBgClass="bg-warning bg-opacity-10 text-warning" buttonText="Gérer" :buttonUrl="route('admin.missions')"
            buttonClass="warning" />

        <x-dashboard-card title="Autres" :count="$othersCount ?? 0" icon="bi-box-arrow-right"
